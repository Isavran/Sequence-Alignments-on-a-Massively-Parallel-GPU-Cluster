 ...
 * As the programs were written for research purposes only, they have not been tested to
 * the degree that would be advisable in any important application. All use of these
...
#define SD_MPI_FP_TYPE MPI_DOUBLE
//#define SD_MPI_FP_TYPE MPI_FLOAT
...
void getCommandLineParams(t_Params *ptParams,int argc,char *argv[]);
FLOAT_T needlemanWunsch(const char* acA, const char* acB, int nLenA, int nLenB, int nM);
